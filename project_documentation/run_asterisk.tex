...
\pagebreak
\section{Helper Functions of Asterisk}	\label{sec:helper-asterisk}
			...
			\begin{itemize}[leftmargin=1.7cm]
				...
				\item[\textbf{Step 2:}] Type command ``{\fontfamily{cmtt}\selectfont{sudo su}}''\\
					\begin{minipage}{\textwidth}
						...
						\vspace{2mm}
					\end{minipage}
				\item[\textbf{Step 3:}] Type command ``{\fontfamily{cmtt}\selectfont{bash source\_code/asterisk\_helper\_scripts/add\_user.sh}}''
				...
				\item[\textbf{Step 6:}] Enter Password	\\
					\begin{minipage}{\textwidth}
						\vspace{2mm}
						\includegraphics[scale=0.35]{Images/raspberry_pi/asterisk_helper/add_user.png}
						\vspace{2mm}
					\end{minipage}
			\end{itemize}
	\end{itemize}