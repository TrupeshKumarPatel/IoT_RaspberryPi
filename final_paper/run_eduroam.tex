		...
		\begin{itemize}[leftmargin=1.8cm]
			...
			\item[\textbf{Step 3:}] Type command ``{\fontfamily{cmtt}\selectfont{sudo su}}'' ~\danger\textbf{NOTE} ~This command to get sudo access to Raspberry Pi \danger\\
				\begin{minipage}{\textwidth}
					...
					\vspace{2mm}
				\end{minipage}
			\item[\textbf{Step 4:}] Type command ``{\fontfamily{cmtt}\selectfont{chmod +x IoT\_RaspberryPi/source\_code/eduroam\_co\\nfig/config\_eduroam.sh}}''\\
				\begin{minipage}{\textwidth}
					\vspace{2mm}
					\includegraphics[scale=0.17]{Images/raspberry_pi/eduroam_config/permission_x.png}
					\vspace{2mm}
				\end{minipage}
			...
			\item[\textbf{Step 7:}] Enter your crimson password\\
				\begin{minipage}{\textwidth}
					\vspace{2mm}
					\includegraphics[scale=0.15]{Images/raspberry_pi/eduroam_config/run_eduroam_conf.png}
					\vspace{2mm}
				\end{minipage}
